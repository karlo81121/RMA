...
import com.example.volleyballapp.Adapter.MyTeamAdapter
import com.example.volleyballapp.Models.TeamViewModel
...
lateinit var teamAdapter: MyTeamAdapter
...
class TeamFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        teamViewModel.allTeams.observe(viewLifecycleOwner, Observer {
